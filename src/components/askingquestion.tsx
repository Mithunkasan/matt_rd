import { Box, Flex, Heading, Text, Accordion, AccordionItem, AccordionButton, AccordionPanel, Icon, Image, Button, Center, useColorModeValue } from "@chakra-ui/react";
...
const FAQComponent = () => {
  ...
  return (
    <Box p={8} bg={bg} className="component1">
      ...
      <Flex direction={{ base: "column", md: "row" }} alignItems="center" gap={10} maxW="1200px" mx="auto">
        <Box flex="1">
          ...
          <Heading as="h2" fontSize="4xl" color={useColorModeValue("blue.900", "blue.200")} mb={6} className="component1">Find Every Answer Here</Heading>
                  ...
                  <>
                    <AccordionButton className="component1">
                      <Flex alignItems="center">
                        ...
                        <Text flex="1" fontSize="lg" fontWeight="bold" color={useColorModeValue("blue.900", "blue.100")} mb={0} p={0}>
                          {faq.question}
                        </Text>
                      </Flex>
                    </AccordionButton>
                    <AccordionPanel pb={4}>
                      <Text color={useColorModeValue("gray.600", "gray.300")} fontSize="lg">{faq.answer}</Text>
                    </AccordionPanel>
                  </>
                )}
              </AccordionItem>
